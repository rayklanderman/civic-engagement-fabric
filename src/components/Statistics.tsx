    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 bg-white shadow-lg">
          <h3 className="text-lg font-semibold mb-2 text-blue-600">Total Participants</h3>
        ...
        <Card className="p-6 bg-white shadow-lg">
          <h3 className="text-lg font-semibold mb-2 text-blue-600">Active Bills</h3>
        ...
        <Card className="p-6 bg-white shadow-lg">
          <h3 className="text-lg font-semibold mb-2 text-blue-600">Counties Engaged</h3>
          <p className="text-4xl font-bold text-gray-900">47</p>
      ...
      {/* Bill Analytics */}
      <Card className="p-6 bg-white shadow-lg">
        <h3 className="text-xl font-semibold mb-4 text-blue-600">Bill Analytics</h3>
        <BillAnalytics />
      </Card>

      {/* County Participation */}
      <Card className="p-6 bg-white shadow-lg">
        <h3 className="text-xl font-semibold mb-4 text-blue-600">Top Participating Counties</h3>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 mx-4">
              <div className="h-2 bg-gray-200 rounded">
                <div className="h-full bg-blue-600 rounded" style={{ width: '68%' }}></div>
              </div>
            </div>
